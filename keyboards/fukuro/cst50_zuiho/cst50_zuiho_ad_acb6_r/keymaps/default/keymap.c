...
const rgblight_segment_t PROGMEM layer0[] = RGBLIGHT_LAYER_SEGMENTS(
    ...
    {77, 7, HSV_RED}, {84, 6, HSV_BLUE}//追加モジュール
 );
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT( //ベースレイヤー
        A(KC_GRV), KC_Q, KC_W, KC_E, KC_R, KC_T,         KC_Y, KC_U, KC_O, KC_MINS, KC_BSPC,
        KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G,             KC_H, KC_J, KC_K, KC_L, KC_P, KC_ENT,            LALT(KC_RIGHT), MS_BTN2,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_V, KC_B,     KC_B, KC_N, KC_M, KC_COMM, KC_DOT, LT(3, KC_ENT), LALT(KC_LEFT), LT(1, KC_ENT),
        KC_LCTL, KC_LGUI, KC_LALT,                                         KC_GRV, KC_SLSH, LT(2, KC_BSLS), MS_BTN1, MS_BTN3,
